...
func generate_tracks():
	...
	for i in range(steps + 1):
		...
		# UV coordinates for current segment
		var u = t * length / segment_length  # Scale U by track length
		...
		# UV coordinates for next segment
		var next_u = next_t * length / segment_length
